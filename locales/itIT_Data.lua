...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "6762e305", text = "(Facoltativo) Uccidi ogni raro una volta in ogni zona per fama. Questo è un bonus unico per ogni raro e non si resetta settimanalmente." },
...

    {
        ...
        items = {
            ...
            { id = "636c0b3a", text = "Completa 4x Preda Difficile per equipaggiamento Veterano e stemmi Veterano su ogni personaggio" }, -- ⚠️ UNVERIFIED
            { id = "efb035ba", text = "(Facoltativo) Completa 2x Preda Difficile casuali per stemmi Veterano su ogni personaggio - completando 2x facoltativi a settimana raggiungerai il limite di stemmi Veterano entro la fine della settimana 2" }, -- ⚠️ UNVERIFIED
