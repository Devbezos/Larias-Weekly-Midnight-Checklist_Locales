...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Completa la festa settimanale di Saltheril nei Boschi di Cantargento. Non dimenticare di prendere la missione di fama per l'elmo del campione se hai la fama necessaria" },
        },
    },

    {
        ...
        items = {
            ...
            { id = "d9a7e304", text = "Aumenta la fama di Lunargenta al rango 9 per 1/6 dell'elmo del campione - disponibile nell'accesso anticipato - si ottiene da una missione dal venditore di fama (non acquistabile)" },
