...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "ca5a8044", text = "Falls verfügbar, schließe die PvP-Quest für garantierten Helden-Hals/Ring ab - kann vielleicht mit der optionalen PvP-Wertung unten gemacht werden" },
...

    {
        ...
        items = {
            ...
            { id = "5bdc8d65", text = "Verfolge ausgegebene Wappen: 220/220 Heroisch, 0/220 Mythisch - halte niemals mythische Wappen zurück" },
...

    {
        ...
        items = {
            ...
            { id = "a501f690", text = "Verfolge ausgegebene Wappen: 320/320 Heroisch, 160/320 Mythisch - halte niemals mythische Wappen zurück" },
            { id = "02884180", text = "Endgegenstandsstufe: 3x266, 8x269, 2x276h, 1x285(hergestellt), 1x289" },
        },
    },
