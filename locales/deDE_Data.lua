...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Schließe die wöchentliche Salthérils Soiree in den Immersangwäldern ab. Vergiss nicht, die Ruhmquest für den Championenhelm zu holen, wenn du den Ruhm hast" }, -- ⚠️ UNVERIFIED
        },
    },

    {
        ...
        items = {
            ...
            { id = "d9a7e304", text = "Erhöhe den Silbermond-Ruhm auf Rang 9 für 1/6 Championenhelm - verfügbar im Early Access - kommt von einer Quest vom Ruhmhändler (nicht gekauft)" }, -- ⚠️ UNVERIFIED
