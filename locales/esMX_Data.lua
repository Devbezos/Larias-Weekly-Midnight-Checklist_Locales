...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "6762e305", text = "(Opcional) Mata cada raro una vez en cada zona para obtener renombre. Este es un bono único por cada raro y no se reinicia semanalmente." },
...

    {
        ...
        items = {
            ...
            { id = "636c0b3a", text = "Completa 4x Presa Difícil para obtener equipo Veterano y blasones Veterano en cada personaje" }, -- ⚠️ UNVERIFIED
            { id = "efb035ba", text = "(Opcional) Completa 2x Presa Difícil aleatorias para obtener blasones Veterano en cada personaje - completar 2x opcionales por semana alcanzará el máximo de blasones Veterano al final de la semana 2" }, -- ⚠️ UNVERIFIED
