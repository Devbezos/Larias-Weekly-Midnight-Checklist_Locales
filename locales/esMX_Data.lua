...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Completa la Velada de Saltheril semanal en Bosque Canción Eterna. No olvides tomar la misión de renombre para el yelmo de campeón si tienes el renombre" },
        },
    },
