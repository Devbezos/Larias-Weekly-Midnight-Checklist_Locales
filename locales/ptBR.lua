...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Oculta o aviso exibido quando a janela de rolagem de bônus é aberta.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "Ocultar Avisos de Rolagem de Bônus", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600Aviso:|r Rolagens de bônus estão com erros atualmente.\nRecomenda-se não usá-las.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "Ocultar Aviso de Rolagem de Bônus", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "Não há proteção contra duplicatas.", -- ⚠️ UNVERIFIED
