...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Complete a Festa de Saltheril semanal em Bosque Etéreo. Não se esqueça de pegar a missão de renome para o elmo de campeão se você tiver o renome" }, -- ⚠️ UNVERIFIED
        },
    },

    {
        ...
        items = {
            ...
            { id = "d9a7e304", text = "Aumente o renome de Lua Prateada para nível 9 para 1/6 do elmo de campeão - disponível no acesso antecipado - vem de uma missão do vendedor de renome (não é comprado)" }, -- ⚠️ UNVERIFIED
