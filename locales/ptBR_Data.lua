...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "6762e305", text = "(Opcional) Mate cada raro uma vez em cada zona para renome. Este é um bônus único para cada raro e não é reiniciado semanalmente." },
...

    {
        ...
        items = {
            ...
            { id = "636c0b3a", text = "Complete 4x Presa Difícil para equipamento Veterano e brasões Veteranos em cada personagem" }, -- ⚠️ UNVERIFIED
            { id = "efb035ba", text = "(Opcional) Complete 2x Presa Difícil aleatória para brasões Veteranos em cada personagem - fazendo 2x opcionais por semana alcançará o limite de brasões Veteranos até o final da semana 2" }, -- ⚠️ UNVERIFIED
