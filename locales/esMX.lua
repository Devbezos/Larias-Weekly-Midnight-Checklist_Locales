...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Oculta la advertencia que se muestra cuando se abre la ventana de tirada de bonificación.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "Ocultar advertencias de tirada de bonificación", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600Advertencia:|r Las tiradas de bonificación tienen errores actualmente.\nSe recomienda no usarlas.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "Ocultar advertencia de tirada de bonificación", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "No hay protección contra duplicados.", -- ⚠️ UNVERIFIED
    ...
    CLOSE                        = "Cerrar", -- ⚠️ UNVERIFIED
    PICKER_RESET_WEEK_TOOLTIP    = "Restablecer a la semana:", -- ⚠️ UNVERIFIED
    PICKER_GO_TO_WEEK_TOOLTIP    = "Ir a la semana:", -- ⚠️ UNVERIFIED
    TRACKING_CREST_AMOUNT_TOOLTIP = "Registra con precisión cuántos blasones puedes conservar, incluidos los que superan el límite", -- ⚠️ UNVERIFIED
}
