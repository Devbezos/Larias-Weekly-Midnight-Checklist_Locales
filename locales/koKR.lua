...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "보너스 굴림 창이 열릴 때 표시되는 경고를 숨깁니다.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "보너스 굴림 경고 숨기기", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600경고:|r 보너스 굴림에 현재 버그가 있습니다.\n사용하지 않을 것을 권장합니다.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "보너스 굴림 경고 숨기기", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "중복 방지 기능이 없습니다.", -- ⚠️ UNVERIFIED
