...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Nasconde l'avviso mostrato quando si apre la finestra del tiro bonus.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "Nascondi avvisi tiro bonus", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600Attenzione:|r I tiri bonus sono attualmente buggati.\nSi consiglia di non utilizzarli.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "Nascondi avviso tiro bonus", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "Non c'è protezione contro i duplicati.", -- ⚠️ UNVERIFIED
