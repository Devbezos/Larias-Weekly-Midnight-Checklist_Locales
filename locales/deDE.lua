...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Blendet die Warnung aus, die beim Öffnen des Bonuswürfel-Fensters erscheint.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "Bonuswürfel-Warnungen ausblenden", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600Warnung:|r Bonuswürfe sind derzeit fehlerhaft.\nEs wird empfohlen, sie nicht zu verwenden.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "Bonuswürfel-Warnung ausblenden", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "Es gibt keinen Duplikatschutz.", -- ⚠️ UNVERIFIED
    ...
    CLOSE                        = "Schließen", -- ⚠️ UNVERIFIED
    PICKER_RESET_WEEK_TOOLTIP    = "Auf Woche zurücksetzen:", -- ⚠️ UNVERIFIED
    PICKER_GO_TO_WEEK_TOOLTIP    = "Zur Woche:", -- ⚠️ UNVERIFIED
    TRACKING_CREST_AMOUNT_TOOLTIP = "Verfolgt genau, wie viele Wappen du behalten kannst, einschließlich überkappter Wappen", -- ⚠️ UNVERIFIED
}
