...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "6762e305", text = "(Opcional) Mata a cada raro una vez en cada zona para obtener renombre. Esta es una bonificación única para cada raro y no se reinicia semanalmente." },
...

    {
        ...
        items = {
            ...
            { id = "efb035ba", text = "(Opcional) Completa 2 Presa Difícil aleatorias para obtener blasones Veteranos en cada personaje - completando 2 opcionales por semana alcanzarás el tope de blasones Veteranos al final de la semana 2" }, -- ⚠️ UNVERIFIED
