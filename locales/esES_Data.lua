...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "90db618c", text = "Sube personajes con modo guerra activado hasta nivel 90 - FDL abre el domingo para 10% más de exp." },
            ...
            { id = "8bf4f442", text = "Completa el logro Cazador de historia de Medianoche para renombre - consulta la documentación para la guía" }, -- ⚠️ UNVERIFIED
            { id = "c886190c", text = "Completa el logro Picos Más Altos para renombre - consulta la documentación para la guía" }, -- ⚠️ UNVERIFIED
            { id = "f9b8eb01", text = "Completa cadenas de misiones secundarias para renombre. (se puede hacer con alternativos para subir de nivel al mismo tiempo). El beneficio de FDL no otorga renombre." },
            { id = "fc025216", text = "Nota: Solo el abalorio de renombre de campeón de la Singularidad está disponible en acceso anticipado - los demás estarán disponibles el lunes después del lanzamiento oficial o tras el reinicio semanal de cada región." },
        },
    },
...

    {
        ...
        items = {
            ...
            { id = "1e5c80bc", text = "(¿Opcional?) Completa un Tour Mundial de mazmorras M0 - recompensa nivel de objeto de campeón" },
