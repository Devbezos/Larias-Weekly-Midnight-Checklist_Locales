...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Completa la Velada de Saltheril semanal en el Bosque Canción Eterna. No olvides recoger la misión de renombre para el yelmo de campeón si tienes el renombre" },
        },
    },

    {
        ...
        items = {
            ...
            { id = "d9a7e304", text = "Sube el renombre de Luna Argenta a rango 9 para 1/6 del yelmo de campeón - disponible en acceso anticipado - viene de una misión del vendedor de renombre (no se compra)" }, -- ⚠️ UNVERIFIED
