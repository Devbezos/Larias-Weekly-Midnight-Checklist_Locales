...
local DATASET = {
...

    {
        ...
        items = {
            { id = "18fb09f9", text = "Guarda 160 emblemas de Veterano para fabricar 2 objetos de Veterano con Adornos (Estos no consumen Chispas)" },
...

    {
        ...
        items = {
            { id = "18fb09f9", text = "Guarda 160 emblemas de Veterano para fabricar 2 objetos de Veterano con Adornos (Estos no consumen Chispas)" },
            { id = "907d099d", text = "Nota especial para clases de doble empuñadura - probablemente puedas fabricar ahora. Consulta la Guía sobre qué y cuándo fabricar." },
            ...
            { id = "161febe2", text = "Si asaltas el martes 17, fabrica piezas de Veterano con Adornos que no consuman chispas. Consulta la guía para más información." },
        },
    },

    {
        ...
        items = {
            ...
            { id = "2f4447eb", text = "Nota especial para Guerreros Furia - probablemente puedas fabricar ahora. Consulta la Guía sobre qué y cuándo fabricar." },
            ...
            { id = "ca5a8044", text = "Si está disponible, completa la misión JcJ para cuello/anillo de héroe garantizado - quizás se pueda hacer con la clasificación JcJ opcional de abajo" },
            ...
            { id = "1104f71c", text = "(Opcional) Completa un Tour Mundial de mazmorras M0 - recompensa nivel de objeto de campeón - bloqueo diario - ¡NO TE QUEMES! M+ se abre la próxima semana y reemplazará todo esto." },
            { id = "7828e484", text = "(Opcional) Si no quieres hacer tours mundiales de mazmorras M0 cada día, considera hacer una mazmorra con un abalorio muy bueno cada día para tener la oportunidad de conseguirlo" },
            { id = "22842538", text = "Completa 2 Presa de Pesadilla para equipo de Campeón en cada personaje" },
            { id = "b8a280cb", text = "Si Pesadilla tiene una misión semanal para un objeto de ruta de Héroe, haz eso también." },
            ...
            { id = "e796ddb6", text = "Aún no confirmado - llena tu cámara en cada ranura para múltiples oportunidades de objetos de conjunto la próxima semana." },
            { id = "a73e9cab", text = "Antes del asalto, fabrica 2 piezas de nivel 246, 2 adornos en ranuras débiles, usa 160 Emblemas Vet. Estos no consumen Chispas. Consulta la Guía para más información." },
            { id = "679a07b9", text = "Antes del asalto, gasta todos los Emblemas de Aventurero, Veterano y Campeón mejorando cualquier cosa. No gastes emblemas Heroicos o Míticos." },
...

    {
        ...
        items = {
            ...
            { id = "e4965db1", text = "Antes del asalto Mítico, Mejora 11 objetos de héroe 3/6 una vez cada uno. Si no tienes tantos objetos Heroicos, mejora un anillo o abalorio más para reducir el riesgo de desperdiciar emblemas." },
            { id = "cbfb6966", text = "Mítico: si tienes un objeto de pista mítica, pasa a los consejos de mejora de la semana siguiente." },
            { id = "5bdc8d65", text = "Seguimiento de emblemas gastados: 220/220 Heroico, 0/220 Mítico - nunca guardes emblemas Míticos" },
...

    {
        ...
        items = {
            ...
            { id = "a501f690", text = "Seguimiento de emblemas gastados: 320/320 Heroico, 160/320 Mítico - nunca guardes emblemas Míticos" },
