...
local STRINGS = {
    ...
    OPTIONS_TOOLTIP_DISABLE_BONUS_ROLL_WARN = "Скрывает предупреждение, отображаемое при открытии окна бонусных бросков.", -- ⚠️ UNVERIFIED
    ...
    OPTIONS_DISABLE_BONUS_ROLL_WARN = "Скрыть предупреждения о бонусных бросках", -- ⚠️ UNVERIFIED
    ...
    BONUS_ROLL_WARN_MSG             = "|cffff6600Предупреждение:|r Бонусные броски в данный момент содержат ошибки.\nРекомендуется не использовать их.", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_BTN     = "Скрыть предупреждение о бонусных бросках", -- ⚠️ UNVERIFIED
    BONUS_ROLL_WARN_DISABLE_TOOLTIP = "Защита от дубликатов отсутствует.", -- ⚠️ UNVERIFIED
