...
local DATASET = {
...

    {
        ...
        items = {
            ...
            { id = "161febe2", text = "Si vous faites le raid mardi 17, fabriquez des pièces de Vétéran avec Embellissements qui ne nécessitent pas d'étincelles. Consultez le guide pour plus d'informations." },
        },
    },

    {
        ...
        items = {
            ...
            { id = "2f4447eb", text = "Note spéciale pour les Guerriers Fureur - vous pouvez probablement fabriquer maintenant. Consultez le Guide pour savoir quoi fabriquer et quand." },
            ...
            { id = "ca5a8044", text = "Si disponible, terminez la quête JcJ pour un collier/anneau de héros garanti - peut peut-être se faire avec le classement JcJ optionnel ci-dessous" },
            ...
            { id = "1104f71c", text = "(Optionnel) Faites une Tournée mondiale des donjons M0 - récompense ilvl de champion - verrouillage quotidien - NE VOUS ÉPUISEZ PAS ! Les M+ ouvrent la semaine prochaine et remplaceront tout cela." },
            { id = "7828e484", text = "(Optionnel) Si vous ne voulez pas faire des tournées mondiales de donjons M0 chaque jour, envisagez de faire un donjon avec un très bon bijou chaque jour pour avoir une chance de l'obtenir" },
            { id = "22842538", text = "Terminez 2 Proies cauchemardesques pour équipement de Champion sur chaque personnage" },
            { id = "b8a280cb", text = "Si Cauchemar a une quête hebdomadaire pour un objet de piste Héros, faites-le également." },
            ...
            { id = "a73e9cab", text = "Avant le raid, fabriquez 2 pièces ilvl 246, 2 embellissements sur des emplacements faibles, utilisez 160 Crêtes de Vét. Ceux-ci ne nécessitent pas d'Étincelles. Consultez le Guide pour plus d'informations." },
            { id = "679a07b9", text = "Avant le raid, dépensez toutes les Crêtes d'Aventurier, de Vétéran et de Champion pour améliorer n'importe quoi. Ne dépensez pas de crêtes Héroïques ou Mythiques." },
...

    {
        ...
        items = {
            ...
            { id = "e4965db1", text = "Avant le raid Mythique, Améliorez 11 objets de héros 3/6 une fois chacun. Si vous n'avez pas autant d'objets Héroïques, améliorez un anneau ou un bijou davantage pour réduire le risque de gaspiller des crêtes." },
            ...
            { id = "5bdc8d65", text = "Suivez les crêtes dépensées : 220/220 Héroïque, 0/220 Mythique - ne conservez jamais de crêtes Mythiques" },
...

    {
        ...
        items = {
            ...
            { id = "a501f690", text = "Suivez les crêtes dépensées : 320/320 Héroïque, 160/320 Mythique - ne conservez jamais de crêtes Mythiques" },
