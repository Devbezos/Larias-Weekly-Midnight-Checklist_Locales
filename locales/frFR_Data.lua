...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "6762e305", text = "(Optionnel) Tuez chaque rare une fois dans chaque zone pour le renom. C'est un bonus unique pour chaque rare qui ne se réinitialise pas chaque semaine." },
...

    {
        ...
        items = {
            ...
            { id = "636c0b3a", text = "Terminez 4x Proie difficile pour l'équipement Vétéran et les armoiries Vétéran sur chaque personnage" }, -- ⚠️ UNVERIFIED
            { id = "efb035ba", text = "(Optionnel) Terminez 2x Proie difficile aléatoire pour les armoiries Vétéran sur chaque personnage - faire 2x optionnel par semaine atteindra la limite d'armoiries Vétéran à la fin de la semaine 2" }, -- ⚠️ UNVERIFIED
