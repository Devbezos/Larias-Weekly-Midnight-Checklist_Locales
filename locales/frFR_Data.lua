...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "ba1890e4", text = "Complétez la Soirée de Saltheril hebdomadaire dans les Bois des Chants éternels. N'oubliez pas de prendre la quête de renom pour le casque de champion si vous avez le renom nécessaire" },
        },
    },

    {
        ...
        items = {
            ...
            { id = "d9a7e304", text = "Augmentez le renom de Lune-d'argent au rang 9 pour le casque de champion 1/6 - disponible en accès anticipé - provient d'une quête du vendeur de renom (non acheté)" },
